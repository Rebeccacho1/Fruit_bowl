...
def add_to_fruit_bowl(m):
    ...
    number_fruit = get_integer("How many fruits did you want to add? ")
    my_L = [add_fruit, number_fruit]
    m.append(my_L)
    output = "You have {} {} added to the list.".format(number_fruit, add_fruit)
    print(output)
